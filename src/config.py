...
class RunConfig:
    ...
    noise_regularization_lambda_ac: float = 0#20.0

    noise_regularization_lambda_kl: float = 0#0.065
    
    noise_regularization_num_reg_steps: int = 0#4

    noise_regularization_num_ac_rolls: int = 0#5
