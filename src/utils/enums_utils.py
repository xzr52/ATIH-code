...
from src.pipes.sdxl_inference_pipeline import sdxl_inference_pipeline
...
def model_type_to_class(model_type):
    if model_type == Model_Type.SDXL:
        ...
        return sdxl_inference_pipeline, SDXLDDIMPipeline
...
def model_type_to_model_name(model_type):
    if model_type == Model_Type.SDXL:
        ...
        return '/root/.cache/huggingface/hub/models--stabilityai--sdxl-turbo/snapshots/6a16f412e1acf6e413cda1abe869f32888a156fa'
    elif model_type == Model_Type.LCM_SDXL:
        return "stabilityai/stable-diffusion-xl-base-1.0"
    elif model_type == Model_Type.SD15:
